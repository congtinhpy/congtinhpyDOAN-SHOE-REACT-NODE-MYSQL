      ...
      <div className=" mt-4 mb-5 container-style">
        ...
        <div className="row">
          <div className="col-2 filter-bar">
            ...
            <div>
              <button className="btn btn-dark btn-sm filter" onClick={this.fetchFilteredProducts}><p>Lọc</p></button>
              <button className="btn btn-light btn-sm ms-2 filter" onClick={this.resetFilter}><p>Đặt lại bộ lọc</p></button>
            </div>
          </div>
